...
unsigned long Layout[NUM_LAYERS][NUM_EVENTS] = {
  {
    KEY_ESC, KEY_F1, KEY_F2, KEY_F3, KEY_F4, KEY_F5, KEY_F6, KEY_F7, KEY_F8, KEY_F9, KEY_F10, KEY_F11, KEY_F12, ( LED_TOGGLE | ON_EVENTS ), KEY_MEDIA_PLAY_PAUSE, KEY_MEDIA_MUTE, (TOGGLE_WIN_KEY | ON_EVENTS),
